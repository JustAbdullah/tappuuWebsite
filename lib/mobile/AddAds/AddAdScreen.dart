...
class _AddAdScreenState extends State<AddAdScreen> {
  ...
  // ========= FIX #1: تحديث صلاحية خطوة الخصائص فورياً بدون ضغطتين =========
  bool _computeAttributesFilledOnly() {
    bool allValid = true;
    for (var attribute in controller.attributes) {
      if (attribute.required == true) {
        final v = controller.attributeValues[attribute.attributeId];
  ...
  void _recalcAttributesValidity() {
    final valid = _computeAttributesFilledOnly();
    if (_stepValid[2] != valid && mounted) {
      setState(() => _stepValid[2] = valid);
    }
  }
  ...
  Widget _buildStepHeader() {
    return Container(
      ...
      decoration: BoxDecoration(color: AppColors.card(isDark), boxShadow: [
        BoxShadow(
  ...
  Widget _buildStepControls() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border(top: BorderSide(color: AppColors.divider(isDark), width: 1))),
      child: Row(
        ...
        builder: (context) => AlertDialog(
              title: Text('هل أنت متأكد؟',
                  ...
                  style: TextStyle(
                      fontFamily: AppTextStyles.appFontFamily,
                      fontWeight: FontWeight.bold)),
              content: Text('سيتم فقدان جميع البيانات التي أدخلتها',
                  textAlign: TextAlign.center,
  ...
  Widget _buildCategoryStep() => _buildStepScaffold(
          'الخطوة 2: التصنيفات', 'اختر التصنيف المناسب لإعلانك', Column(children: [
        _buildMainCategoryDropdown(),
        SizedBox(height: 16.h),
        Obx(() =>
            controller.subCategories.isNotEmpty ? _buildSubcategoryDropdown() : SizedBox()),
        SizedBox(height: 16.h),
    ...
    return SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => controller.attributes.isEmpty
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        _attributeFormKeys.putIfAbsent(
                            attribute.attributeId, () => GlobalKey<FormState>());
  ...
  Widget _buildLargeDescriptionField() {
    ...
    controller.descriptionArController.addListener(() {
      if (_formKey.currentState != null)
        errorText.value = controller.descriptionArController.text.isEmpty
      ...
      Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
              ...
              hintStyle: TextStyle(fontFamily: AppTextStyles.appFontFamily)),
          style: TextStyle(
              fontFamily: AppTextStyles.appFontFamily,
              color: AppColors.textPrimary(isDark)),
          validator: (value) =>
              value == null || value.isEmpty ? 'يرجى إدخال وصف الإعلان' : null,
          onChanged: (value) =>
              setState(() => _stepValid[3] = _formKey.currentState?.validate() ?? false),
        ),
      ),
  ...
  Widget _buildLocationStep() => _buildStepScaffold(
          'الخطوة 5: الموقع', 'الحقول المطلوبة علامة (*)', Column(children: [
        _buildCityDropdown(),
        SizedBox(height: 16.h),
        ...
        OutlinedButton.icon(
          onPressed: () async {
            ...
            if (controller.latitude.value != null && controller.longitude.value != null)
              setState(() => _stepValid[4] = controller.selectedCity.value != null &&
                  controller.selectedArea.value != null);
          },
        ...
        Obx(() => controller.latitude.value != null && controller.longitude.value != null
  ...
  Widget _buildNoLocationMessage() => Padding(
      padding: EdgeInsets.only(top: 16.h),
      child: Text('لم يتم تحديد الموقع بعد',
          style: TextStyle(
              fontFamily: AppTextStyles.appFontFamily,
              color: AppColors.textSecondary(isDark))));
    ...
    return Stack(children: [
      ...
      Obx(() {
        ...
        if (hasImages != _stepValid[5])
          WidgetsBinding.instance.addPostFrameCallback((_) => setState(() => _stepValid[5] = hasImages));
  ...
  Widget _buildMediaContent() => _buildStepScaffold(
          'الخطوة 6: الوسائط', 'إضافة الصور والفيديو (اختياري)', Column(children: [
        _buildImagesSection(),
        SizedBox(height: 24.h),
        _buildVideosSection(),
      ]));
  ...
  Widget _buildReviewStep() => SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SizedBox(height: 16.h),
        Center(
            child: Text(controller.selectedProfile.value?.name ?? 'اسم المعلن',
                style: TextStyle(
                    fontFamily: AppTextStyles.appFontFamily,
                    fontSize: AppTextStyles.large,
                    fontWeight: FontWeight.bold,
          ...
          child: controller.images.isNotEmpty
              ...
              : Center(
                  child: Icon(Icons.image,
                      size: 50.w, color: AppColors.textSecondary(isDark)))),
      if (controller.images.isNotEmpty) Positioned(bottom: 10.h, child: _buildImageCounter()),
    ]);
  }

  Widget _buildImageGallery() => PageView.builder(
  ...
  Widget _buildImageCounter() => Container(
        ...
        decoration: BoxDecoration(
            color: Colors.black54, borderRadius: BorderRadius.circular(20.r)),
        child: Obx(() => Text(
  ...
  Widget _buildCategoryPath() => Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        Text(controller.selectedMainCategory.value?.translations.first.name ?? 'التصنيف الرئيسي',
            style: TextStyle(
                fontFamily: AppTextStyles.appFontFamily,
                fontSize: AppTextStyles.small,
        ...
        SizedBox(width: 4.w),
        Text(controller.selectedSubcategoryLevelOne.value?.translations.first.name ?? 'التصنيف الفرعي',
            style: TextStyle(
                fontFamily: AppTextStyles.appFontFamily,
                fontSize: AppTextStyles.small,
                fontWeight: FontWeight.w600,
        ...
        if (controller.selectedSubcategoryLevelTwo.value != null) ...[
          ...
          Icon(Icons.chevron_right, size: 12.sp, color: AppColors.primary),
          SizedBox(width: 4.w),
          Text(controller.selectedSubcategoryLevelTwo.value!.translations.first.name,
              style: TextStyle(
                  fontFamily: AppTextStyles.appFontFamily,
                  fontSize: AppTextStyles.small,
                  fontWeight: FontWeight.w600,
  ...
  Widget _buildLocationInfo() => Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        Text(controller.selectedCity.value?.translations.first.name ?? 'المدينة',
            style: TextStyle(
                fontFamily: AppTextStyles.appFontFamily,
                fontSize: AppTextStyles.small,
                fontWeight: FontWeight.w600,
        ...
        Text("/",
            style: TextStyle(
                ...
                color: AppColors.buttonAndLinksColor)),
        SizedBox(width: 4.w),
        Text(controller.selectedArea.value?.name ?? 'المنطقة',
            style: TextStyle(
                fontFamily: AppTextStyles.appFontFamily,
                fontSize: AppTextStyles.small,
                fontWeight: FontWeight.w600,
  ...
  Widget _buildReviewTabs() => Container(
      decoration: BoxDecoration(
          color: AppColors.background(isDark),
          borderRadius: BorderRadius.circular(12.r)),
      child: Row(children: [
  ...
  Widget _buildReviewTabButton(int index, String title) {
    ...
    return Expanded(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: selected ? AppColors.yellow : AppColors.surface(isDark),
            border: Border(
                bottom: BorderSide(
        ...
        child: Center(
            child: Text(title,
                style: TextStyle(
                    ...
                    fontSize: AppTextStyles.small,
                    fontWeight: FontWeight.bold,
                    color: selected ? Colors.black : AppColors.textSecondary(isDark)))),
      ),
    ));
  }
  ...
  Widget _buildActiveTabContent() {
    switch (_reviewTabIndex) {
      case 0:
        return _buildAttributesReview();
      case 1:
        return _buildDescriptionReview();
      case 2:
        return _buildLocationReview();
      default:
        return SizedBox();
    }
  }

  Widget _buildAttributesReview() => Container(
      padding: EdgeInsets.symmetric(horizontal: 16.w),
      child: Column(children: [
        ...
        ...controller.attributes
            .map((attribute) => Column(children: [
                  _buildAttributeReviewItem(attribute),
                  Divider(height: 24.h, color: AppColors.divider(isDark))
                ]))
            .toList(),
      ]));
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Text('السعر',
          style: TextStyle(
              ...
              fontSize: AppTextStyles.medium,
              color: AppColors.textPrimary(isDark))),
      Text('${NumberFormat.decimalPattern().format(syrianPrice)} ليرة سورية',
          style: TextStyle(
              fontFamily: AppTextStyles.appFontFamily,
              fontSize: AppTextStyles.medium,
              fontWeight: FontWeight.bold,
  ...
  Widget _buildPublishDateReview() => Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text('تاريخ النشر',
              style: TextStyle(
  ...
  Widget _buildDescriptionReview() => Padding(
      padding: EdgeInsets.symmetric(horizontal: 16.w),
      child: Text(
  ...
  Widget _buildLocationReview() {
    if (controller.latitude.value != null && controller.longitude.value != null) {
      ...
      return Center(
          child: Text('لا يتوفر موقع جغرافي',
              style: TextStyle(
                  fontFamily: AppTextStyles.appFontFamily,
                  fontSize: AppTextStyles.medium,
                  color: AppColors.textSecondary(isDark))));
                ...
                return DropdownMenuItem<AdvertiserProfile>(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(isCompany ? Icons.apartment : Icons.person,
          ...
          _buildDropdown<SubcategoryLevelOne>(
            ...
            items: controller.subCategories
                .map((subcategory) => DropdownMenuItem(
                      value: subcategory,
                      child: Text(subcategory.translations.first.name,
                          style: TextStyle(fontFamily: AppTextStyles.appFontFamily)),
                    ))
                .toList(),
            onChanged: (subcategory) =>
                setState(() => subcategory != null ? controller.selectSubcategoryLevelOne(subcategory) : null),
            icon: Icons.list,
          ),
        ]);
      });
        ...
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _buildDropdown<SubcategoryLevelTwo>(
            ...
            items: controller.subCategoriesLevelTwo
                ...
                .toList(),
            onChanged: (subcategory) =>
                setState(() => subcategory != null ? controller.selectSubcategoryLevelTwo(subcategory) : null),
            icon: Icons.list_alt,
          ),
        ]);
      });
          ...
          _buildDropdown<TheCity>(
            ...
            items: controller.citiesList
                .map((city) => DropdownMenuItem(
                      value: city,
                      child: Text(city.translations.first.name,
                          style: TextStyle(fontFamily: AppTextStyles.appFontFamily)),
                    ))
                .toList(),
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError || !snapshot.hasData || snapshot.data!.isEmpty)
            return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SizedBox(height: 8.h),
              _buildDropdown<Area>(
                  hint: snapshot.hasError ? 'خطأ في جلب البيانات' : 'لا توجد مناطق',
                  value: controller.selectedArea.value,
                  items: [],
                  onChanged: (_) {},
                  icon: Icons.map),
          ...
          final items = areas
              .map((area) => DropdownMenuItem<Area>(
                  value: area,
  ...
  Widget _buildNumberField(Attribute attribute, Color textColor) => Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            RichText(
                text: TextSpan(
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(fontFamily: AppTextStyles.appFontFamily),
                        suffixIcon:
                            Icon(Icons.numbers, color: AppColors.primary, size: 20.w)),
                    style: TextStyle(
                        fontFamily: AppTextStyles.appFontFamily, color: textColor),
                    ...
                    onChanged: (value) {
                      ...
                      if (attribute.required == true) {
                        _attributeFormKeys[attribute.attributeId]?.currentState?.validate();
                      }
                      // ✅ تحديث زر التالي فوراً
                      _recalcAttributesValidity();
                    },
                  ),
                )),
          ]);

  Widget _buildTextField(Attribute attribute, Color textColor) => Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            RichText(
                text: TextSpan(
 ...
 Widget _buildBooleanField(Attribute attribute, Color textColor) {
  return Obx(() {
    final bool? value = controller.attributeValues[attribute.attributeId] as bool?;
  ...
  Widget _buildBooleanOption(String label, bool optionValue, bool isSelected, Attribute attribute) =>
      GestureDetector(
        onTap: () {
          controller.attributeValues[attribute.attributeId] = optionValue;
          // ✅ تحديث زر التالي فوراً (بدون ضغطتين)
          _recalcAttributesValidity();
        },
        child: Container(
 ...
 Widget _buildOptionsField(Attribute attribute, Color textColor) {
  return Obx(() {
    final selected = controller.attributeValues[attribute.attributeId];
  ...
  Widget _buildOptionChip(String label, int value, bool isSelected, Attribute attribute) =>
      ChoiceChip(
        label: Text(label,
            style: TextStyle(
                fontFamily: AppTextStyles.appFontFamily,
  ...
  Widget _buildImagesSection() => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        ElevatedButton.icon(
          onPressed: () async {
            await Future.sync(() => controller.pickImages());
            if (mounted) setState(() {});
          },
  ...
  // ========= FIX #2: الفيديو يعرض مباشرة بعد الاختيار + التعامل مع عدم التهيئة =========
  Widget _buildVideosSection() => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SizedBox(height: 12.h),
        Obx(() {
          final hasSelection = controller.selectedVideos.isNotEmpty;
          final playersCount = controller.videoPlayers.length;

          if (!hasSelection) return _buildEmptyVideosPlaceholder();

          // لو تم اختيار فيديوهات لكن controllers لسه ما اتجهزت
          if (playersCount == 0) {
            return Container(
              height: 120.h,
              width: double.infinity,
              ...
              child: Center(
                child: Text(
                  'تم اختيار ${controller.selectedVideos.length} فيديو — جارٍ التحضير...',
                  style: TextStyle(
                    fontFamily: AppTextStyles.appFontFamily,
                    color: AppColors.textSecondary(isDark),
                  ),
          ...
          final count = playersCount; // نعرض الموجود فقط
          return SizedBox(
            height: 120.h,
            child: ListView.separated(
              ...
              itemBuilder: (context, i) {
                final player = controller.videoPlayers[i];
                final isReady = player.value.isInitialized;
        ...
        ElevatedButton.icon(
          onPressed: () async {
            await Future.sync(() => controller.pickVideos());
            if (mounted) setState(() {});
          },
  ...
  Widget _buildNoDataMessage(String message) => Text(message,
      style: TextStyle(
          fontFamily: AppTextStyles.appFontFamily,
          color: AppColors.textSecondary(isDark)));
  ...
  TextStyle get _fieldLabelStyle =>
      TextStyle(fontFamily: AppTextStyles.appFontFamily, fontWeight: FontWeight.w600);
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          TextButton(
              onPressed: () => _picked != null
                  ...
                  : ScaffoldMessenger.of(context)
                      .showSnackBar(SnackBar(content: Text('الرجاء تحديد النقطة على الخريطة'))),
              child: Text('تأكيد',
                  style: TextStyle(color: Colors.white, fontFamily: AppTextStyles.appFontFamily))),
        ],
      ),
      body: FlutterMap(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () =>
            _picked != null ? Navigator.pop(context, _picked) : Get.snackbar('حدد الموقع', 'الرجاء تحديد موقع على الخريطة'),
