...
class RecommendedAdsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // جلب الإعلانات الموصى بها عند فتح الشاشة
    ...
    return Scaffold(
      ...
      body: Obx(() {
        return Column(
          children: [
            // عنوان قسم الإعلانات الموصى بها
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'إعلانات قد تهمك بناءً على تصفحك'.tr,
                    style: TextStyle(
                      fontFamily: AppTextStyles.appFontFamily,
                  ...
                  Container(
                    ...
                    child: Text(
                      browsingHistoryController.recommendedAds.length.toString(),
                      style: TextStyle(
                        fontFamily: AppTextStyles.appFontFamily,
            ...
            Expanded(
              child: browsingHistoryController.isLoadingRecommended.value
                  ? _buildShimmerLoader(isDarkMode)
                  : browsingHistoryController.recommendedAds.isEmpty
                      ? Center(
                          child: Text(
                      ...
                      : RefreshIndicator(
                          onRefresh: () async {
                            if (loadingC.currentUser != null) {
                              await browsingHistoryController.fetchRecommendedAds(
                                userId: loadingC.currentUser?.id ?? 0,
                                lang: Get.locale?.languageCode ?? 'ar',
                              );
                            }
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: browsingHistoryController.recommendedAds.length,
                            itemBuilder: (context, index) {
                              return RecommendedAdItem(
                                ad: browsingHistoryController.recommendedAds[index],
                              );
                            },
                          ),
                        ),
