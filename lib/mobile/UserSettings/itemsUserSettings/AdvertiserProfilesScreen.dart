                            ...
                            Wrap(
                              ...
                              children: [
                                ElevatedButton.icon(
                                  ...
                                  label: Text(
                                    uploading ? 'جارِ الرفع...' : 'رفع الصورة',
                                  ),
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: AppColors.primary,
                                    foregroundColor: AppColors.onPrimary,
                      ...
                      onPressed: () async {
                        ...
                        await advC.updateMyCompanyMembership(
                          ...
                          contactPhone: phoneCtrl.text.trim().isEmpty
                              ? null
                              : phoneCtrl.text.trim(),
                          whatsappPhone: waCtrl.text.trim().isEmpty
                              ? null
                              : waCtrl.text.trim(),
                          whatsappCallNumber: waCallCtrl.text.trim().isEmpty
                              ? null
                              : waCallCtrl.text.trim(),
                          // الجديد: نمرّر رابط الأفاتار لو موجود
                          avatarUrl:
                              uploadedAvatarUrl.isNotEmpty ? uploadedAvatarUrl : null,
                        );
...
class _ProfileAndMemberCard extends StatelessWidget {
  ...
  /// Helper لتحويل المسار النسبي إلى رابط كامل
