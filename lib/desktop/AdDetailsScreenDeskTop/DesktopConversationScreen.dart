...
class _DesktopConversationScreenState extends State<DesktopConversationScreen> {
        ...
        children: [
          ...
          Expanded(
            child: Row(
              ...
              children: [
                // لوحة معلومات الإعلان (جانبية) - تظهر فقط إذا كان الإعلان موجوداً
                if (widget.ad != null) 
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            '${'المحادثة'.tr} - ${widget.advertiser.name}',
            style: TextStyle(
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: widget.advertiser.logo != null && widget.advertiser.logo!.isNotEmpty
                  ? ClipRRect(
                      borderRadius: BorderRadius.circular(24),
                      child: CachedNetworkImage(
  ...
  Widget _buildAdvertiserAvatar() {
    return widget.advertiser.logo != null && widget.advertiser.logo!.isNotEmpty
      ? ClipRRect(
          borderRadius: BorderRadius.circular(12),
          child: CachedNetworkImage(
            imageUrl: widget.advertiser.logo!,
