...
import 'FavoritesAdItemDeskTop.dart';

// ignore: must_be_immutable
class FavoritesScreenDeskTop extends StatelessWidget {
   int ?idGroup;
  String ?nameOfGroup;
   FavoritesScreenDeskTop({super.key,
   this.idGroup,
                ...
                child: Obx(() {
                  return Column(
                    ...
                    children: [
                      ...
                      _buildTopControls(isDarkMode, favoritesController),
                      Expanded(
                        child: favoritesController.isLoading.value
                            ? _buildShimmerLoader(isDarkMode, favoritesController.viewMode.value)
                            : favoritesController.favorites.isEmpty
                                ? _buildEmptyState(isDarkMode)
                                : _buildFavoritesGrid(isDarkMode, favoritesController, context),
                    ),
                  ]);
                }),
              ),
  ...
  Widget _buildTopControls(bool isDarkMode, FavoritesController controller) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.favorite, size: 18.sp, color: AppColors.primary),
              SizedBox(width: 8.w),
              Text(
  ...
  Widget _buildViewModeToggle(bool isDarkMode, FavoritesController controller) {
    return Obx(() {
      return Container(
        decoration: BoxDecoration(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'اضغط على أيقونة القلب في الإعلانات لإضافتها إلى المفضلة'.tr,
  ...
  Widget _buildFavoritesGrid(bool isDarkMode, FavoritesController controller, BuildContext context) {
    return Obx(() {
      ...
      return RefreshIndicator(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return FavoritesAdItemDeskTop(
              ad: controller.favorites[index],
              viewMode: viewMode,
            );
          },
        ),
