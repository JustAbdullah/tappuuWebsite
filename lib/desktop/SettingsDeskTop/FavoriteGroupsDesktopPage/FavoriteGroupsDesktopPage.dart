...
class FavoriteGroupsDesktopPage extends StatefulWidget {
  const FavoriteGroupsDesktopPage({Key? key}) : super(key: key);

  @override
  State<FavoriteGroupsDesktopPage> createState() => _FavoriteGroupsDesktopPageState();
}

class _FavoriteGroupsDesktopPageState extends State<FavoriteGroupsDesktopPage> {
        ...
        return Dialog(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ListTile(
                  leading: Icon(Icons.edit, color: AppColors.textPrimary(isDark), size: 24.w),
                ...
                ListTile(
                  leading: Icon(Icons.delete, color: Colors.red, size: 24.w),
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        onTap: () {
                          Get.to(() => FavoritesScreenDeskTop(idGroup: group.id, nameOfGroup: group.name));
                        },
                      );
                    },
                  ),
