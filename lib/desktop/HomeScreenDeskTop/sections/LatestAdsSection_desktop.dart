...
class LatestAdsSectionDestop extends StatelessWidget {
  ...
  LatestAdsSectionDestop({required this.adsController});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        // Header with dual tags (مطابق للإعلانات المميزة)
        Padding(
          ...
          child: Wrap(
            ...
            children: [
              ...
              // Tag 2 - أحدث الإعلانات (gradient style)
              Container(
                padding: EdgeInsets.symmetric(horizontal: 16.w, vertical: 6.h),
                decoration: BoxDecoration(
        ...
        Obx(() {
          ...
          return SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => LatestAdItem(
                ad: adsList[index],
                key: ValueKey(adsList[index].id),
              ),
            ),
          );
        }),
...
class LatestAdItem extends StatefulWidget {
  final Ad ad;
  const LatestAdItem({Key? key, required this.ad}) : super(key: key);

  @override
  State<LatestAdItem> createState() => _LatestAdItemState();
}

class _LatestAdItemState extends State<LatestAdItem> with AutomaticKeepAliveClientMixin {
