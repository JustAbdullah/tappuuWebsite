...
class CategoryAdsSectionDeskTop extends StatelessWidget {
  ...
  // نحضّر الكنترولرات مرّة واحدة بدل ما نطلبها جوّا كل آيتم
      ...
      children: [
        ...
        Obx(() {
          final bool isLoading =
              adsController.isLoadingCategoryMap[categoryId] ?? false;
          final List<Ad> adsList =
              adsController.categoryAdsMap[categoryId] ?? [];
          ...
          if (adsList.isEmpty) {
            return _buildCategoryEmptyState(
              ...
              onRetry: () =>
                  adsController.fetchAdsByCategory(categoryId: categoryId),
            );
          }
  ...
  /// واجهة احترافية عندما لا توجد إعلانات / فشل الجلب أو انقطاع الإنترنت
            ...
            children: [
              ...
              Flexible(
                child: Column(
                  ...
                  children: [
                    Text(
                      'لا توجد إعلانات في $categoryName حالياً'.tr,
                      style: TextStyle(
                        fontFamily: AppTextStyles.appFontFamily,
                        fontSize: AppTextStyles.medium,
                    ...
                    SizedBox(height: 4.h),
                    Text(
                      'قد لا توجد إعلانات حالياً في هذا التصنيف، أو قد يكون اتصالك بالإنترنت محدوداً.'
                          .tr,
                      style: TextStyle(
                        fontFamily: AppTextStyles.appFontFamily,
